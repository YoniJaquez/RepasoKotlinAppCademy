package com.example.jetpackcomposecatalog2.login
...
fun Body(modifier: Modifier) {
    ...
    Column(modifier = modifier) {
        ...
        ForgoPassword(Modifier.align(Alignment.End))
        Spacer(modifier = Modifier.size(16.dp))
...
@Composable
fun ForgoPassword(modifier: Modifier) {
...
fun Password(password: String, onTextChange: (String) -> Unit) {
    var passwordVisibity by remember { mutableStateOf(false) }
    TextField(
        value = password,
